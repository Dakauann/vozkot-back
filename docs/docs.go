...
const docTemplate = `{
    ...
    "paths": {
        "/api/v1/checkout": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Chave de idempotência do cliente (UUID)",
                ...
                "responses": {
                    ...
                    "409": {
                        "description": "Chave reutilizada, requisição em andamento ou ingressos esgotados",
                        "schema": {
                            "$ref": "#/definitions/checkout.ErrorResponse"
                        }
                    },
        ...
        "/api/v1/events/{id}/seating/areas": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "description": "Area ticket bindings",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/seating.AreaTicketsRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/checkout.OrderListEnvelope"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/ticket.TicketListEnvelope"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/ticket.CreateRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/ticket.TicketEnvelope"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/ticket.UpdateRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/ticket.ChangeStatusRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/webhooks/mercadopago": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Assinatura HMAC enviada pelo Mercado Pago",
                        "name": "x-signature",
                        "in": "header",
                        "required": true
                    },
                    ...
                    {
                        "type": "string",
                        "description": "ID do pagamento (formato moderno)",
                        "name": "data.id",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Tópico da notificação (formato IPN legado)",
                        "name": "topic",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Notificação ignorada (não é de pagamento)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
    ...
    "definitions": {
        ...
        "checkout.Buyer": {
            ...
            "properties": {
                "document": {
                    "description": "Document is the CPF or CNPJ. PIX in Brazil cannot be issued without one.",
                    "type": "string",
                    "example": "12345678909"
                },
                "email": {
        ...
        "checkout.PaymentResponse": {
            ...
            "properties": {
                ...
                "pixCopyPaste": {
                    "description": "PixCopyPaste is the EMV string a bank app reads.",
                    "type": "string"
                },
                "pixQrCodeBase64": {
                    "description": "PixQRCodeBase64 is the same payload as a PNG, ready for an \u003cimg\u003e tag.",
                    "type": "string"
                },
                "provider": {
        ...
        "seating.LayoutResponse": {
            ...
            "properties": {
                ...
                "seatCount": {
                    "description": "SeatCount is how many named chairs the plan holds. Present on a listing,\nso plans can be told apart without opening each one.",
                    "type": "integer"
                },
                "status": {
                    "type": "string"
        ...
        "seating.MapMarkerResponse": {
            ...
            "properties": {
                "capacity": {
                    "description": "Capacity is how many people it holds, for the counted sections. Omitted\nfor scenery, which holds nobody.",
                    "type": "integer"
                },
                "height": {
                    "type": "number"
        ...
        "seating.SectionRequest": {
            ...
            "properties": {
                ...
                "category": {
                    "description": "Category is the price band this section's seats belong to by default.\nEmpty means the section's own name, which is what an ordinary room wants.",
                    "type": "string",
                    "example": "Plateia"
                },
                "curve": {
        ...
        "ticket.MediaResponse": {
            ...
            "properties": {
                ...
                "url": {
                    "type": "string",
                    "example": "https://cdn.exemplo.com/tickets/tkt_a1b2/med_9f2c1d8a.jpg"
                }
            }
        },
